...
import vistula.sf.roomdb.comments.CommentsListTypeConverter;
import vistula.sf.roomdb.retrofit.UserModel;


@Database(entities = {UserModel.class, CommentListModel.class,CommentModel.class}, version = 1,exportSchema = true)
abstract class CotesDatabase extends RoomDatabase {

    // below line is to create instance
    // for our database class.
    private static CotesDatabase instance;
    ...
    public static synchronized CotesDatabase getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    Room.databaseBuilder(context.getApplicationContext(),
                                    CotesDatabase.class, "cotes_database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        PopulateDbAsyncTask(CotesDatabase instance) {
